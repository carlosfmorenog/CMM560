...
Computer Vision for the Energy Sector (RGU Short Course)

* More info: https://www.rgu.ac.uk/study/courses/5630-computer-vision-for-the-energy-sector

* A tutorial on how to load images from a GitHub repo to a Jupyter Notebook can be found [here](https://github.com/carlosfmorenog/CMM560_Data_Loading_Tutorial)
